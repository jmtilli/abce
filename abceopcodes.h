...
enum abce_opcode {
  ...
  ABCE_OPCODE_EQ = 7,
  ABCE_OPCODE_NE = 8,
  ABCE_OPCODE_PUSH_INT = 9, // RFE make ABCE_OPCODE_NOP again
  ABCE_OPCODE_UNUSED1 = 10,
  //ABCE_OPCODE_LOGICAL_AND = 9, // not used
  //ABCE_OPCODE_LOGICAL_OR = 10, // not used
  ...
  ABCE_OPCODE_LOGICAL_AND = 204, // not used
  ABCE_OPCODE_LOGICAL_OR = 205, // not used
};
